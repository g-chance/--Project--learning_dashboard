...
const TaskForm = props => {
  ...
  const validator = () => {
    ...
    if (formState.position.length > 0 && formState.position.length < 3) temp = true
  ...
  return (
    ...
    <div>
      ...
      <form onSubmit={onSubmitHandler}>
        ...
        <input type="text" id="description" name="description" onChange={onChangeHandler} value={formState.description || ''} />
        <br />
        <label htmlFor="startDate">Start Date</label>
        <input type="date" id="startDate" name="startDate" onChange={onChangeHandler} value={formState.startDate || ''} />
        <br />
        <label htmlFor="dueDate">Due Date</label>
        <input type="date" id="dueDate" name="dueDate" onChange={onChangeHandler} value={formState.dueDate || ''} />
        <br />
